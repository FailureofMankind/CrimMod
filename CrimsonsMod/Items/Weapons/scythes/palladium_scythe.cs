...
{
	public class palladium_scythe : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Palladium Scythe");
			Tooltip.SetDefault("Chance to heal on contact");
		}
		...
		public override void SetDefaults()
		{
            ...
            item.shootSpeed = 1;
            item.useTurn = true;
            item.shoot = mod.ProjectileType("palladium_scythe");  //This defines what type of projectile this weapon will shoot  
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ItemID.PalladiumBar, 19);
