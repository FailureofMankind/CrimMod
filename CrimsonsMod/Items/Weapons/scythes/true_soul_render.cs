...
{
	public class true_soul_render : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("True Soul Render");
			Tooltip.SetDefault("..corruption, greed, destruction..");
		}
		...
		public override void SetDefaults()
		{
            ...
            item.shootSpeed = 1;
            item.useTurn = true;
            item.shoot = mod.ProjectileType("true_soul_render");  //This defines what type of projectile this weapon will shoot  
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(null, "soul_render");
