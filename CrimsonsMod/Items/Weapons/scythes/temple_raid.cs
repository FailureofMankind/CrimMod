...
{
	public class temple_raid : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Temple Raid");
			Tooltip.SetDefault("Unleash the sun's wrath on hit");
		}
		...
		public override void SetDefaults()
		{
            ...
            item.knockBack = 16f;    //The knockback stat of your Weapon.
            ...
            item.shootSpeed = 1;
            item.useTurn = true;
            item.shoot = mod.ProjectileType("temple_raid");  //This defines what type of projectile this weapon will shoot  
