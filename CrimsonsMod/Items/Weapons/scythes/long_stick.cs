...
{
	public class long_stick : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Wooden Stick");
			Tooltip.SetDefault("( ͡° ͜ʖ ͡°)");
		}
		...
		public override void SetDefaults()
		{
            ...
            item.shootSpeed = 1;
            item.useTurn = true;
            item.shoot = mod.ProjectileType("long_stick");  //This defines what type of projectile this weapon will shoot  
