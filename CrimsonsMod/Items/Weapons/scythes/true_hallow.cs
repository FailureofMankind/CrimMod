...
{
	public class true_hallow : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("True Hallows");
			Tooltip.SetDefault("'..chaos, frenzy, crave..");
		}
		...
		public override void SetDefaults()
		{
            ...
            item.shootSpeed = 1;
            item.useTurn = true;
            item.shoot = mod.ProjectileType("true_hallow");  //This defines what type of projectile this weapon will shoot  
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(null, "the_hallow");
