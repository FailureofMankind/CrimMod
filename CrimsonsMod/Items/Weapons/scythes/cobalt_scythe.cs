...
{
	public class cobalt_scythe : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Cobalt Scythe");
			Tooltip.SetDefault("Spin a cobalt blade that slashes enemies");
		}
		...
		public override void SetDefaults()
		{
            ...
            item.shootSpeed = 1;
            item.useTurn = true;
            item.shoot = mod.ProjectileType("cobalt_scythe");  //This defines what type of projectile this weapon will shoot  
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ItemID.CobaltBar, 19);
