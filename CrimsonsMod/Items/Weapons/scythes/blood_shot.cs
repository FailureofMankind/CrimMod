...
{
	public class blood_shot : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Blood Dance");
			Tooltip.SetDefault("Spin a bloody scythe around you");
		}
		...
		public override void SetDefaults()
		{
            ...
            item.value = Item.buyPrice(0, 2, 50, 0); // How much the item is worth, in copper coins, when you sell it to a merchant. It costs 1/5th of this to buy it back from them. An easy way to remember the value is platinum, gold, silver, copper or PPGGSSCC (so this item price is 10gold)
            item.rare = 2;   //The color the title of your Weapon when hovering over it ingame                    
            item.shootSpeed = 1;
            item.useTurn = true;
            item.shoot = mod.ProjectileType("blood_shot");  //This defines what type of projectile this weapon will shoot  
