...
{
	public class terra_scythe : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Terra Scythe");
			Tooltip.SetDefault("'The power of a terrarian warrior'");
		}
		...
		public override void SetDefaults()
		{
            ...
            item.knockBack = 15f;    //The knockback stat of your Weapon.
            ...
            item.shootSpeed = 1;
            item.useTurn = true;
            item.shoot = mod.ProjectileType("terra_scythe");  //This defines what type of projectile this weapon will shoot  
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(null, "true_soul_render");
            recipe.AddIngredient(null, "true_hallow");
