...
namespace CrimsonsMod.Items.Weapons.scythes
{
	public class flare : ModItem
	{
		public override void SetStaticDefaults()
		{
			...
			Tooltip.SetDefault("Explodes on contact on every fifth hit");
		}
		...
		public override void SetDefaults()
		{
            ...
            item.shootSpeed = 1;
            item.useTurn = true;
            item.shoot = mod.ProjectileType("flare");  //This defines what type of projectile this weapon will shoot  
