...
{
	public class manganese_bar : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Manganese Bar");			
			Tooltip.SetDefault("you can feel the pressure of the deep sea only by touching it...");
		}
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(null, "manganese_ore", 3);
