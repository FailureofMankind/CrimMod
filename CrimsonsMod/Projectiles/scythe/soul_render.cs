...
{
    public class soul_render : ModProjectile  
    { 
        ...
        public override void AI()
        {
            ...
            int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, 14);  //this is the dust that this projectile will spawn
            Main.dust[dust].velocity /= 3f;
            Main.dust[dust].scale = 1.6f;
        
            if(Main.rand.Next(20)==0)
            {
                Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0, 0, 274, 30, 4, Main.myPlayer); //Spawning a projectile
            }
