...
{
    public class long_stick : ModProjectile  
    { 
        public override void SetStaticDefaults()
        {
        
		    DisplayName.SetDefault("long_stick");

        }

        public override void SetDefaults()
        {
            projectile.width = 175;     //Set the hitbox width
            projectile.height = 175;       //Set the hitbox height
