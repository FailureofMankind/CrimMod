...
{
    public class true_hallow : ModProjectile  
    { 
        ...
        public override void AI()
        {
            ...
            {
            int a = Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, Main.rand.Next(-7, 7), Main.rand.Next(-7, 7), 521, (int)(projectile.damage / 6), 0, Main.myPlayer); //Spawning a projectile
            Main.projectile[a].magic = false;
            Main.projectile[a].melee = true;
            }

            int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, 86);  //this is the dust that this projectile will spawn
