...
{
    public class mythril_scythe : ModProjectile  
    { 
		...
		{
            Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, Main.rand.Next(-30, 30), Main.rand.Next(-30, 30), mod.ProjectileType("mythril_boomerang"), 40, 0, Main.myPlayer); //Spawning a projectile
            Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, Main.rand.Next(-30, 30), Main.rand.Next(-30, 30), mod.ProjectileType("mythril_boomerang"), 40, 0, Main.myPlayer); //Spawning a projectile
        ...
        public override void AI()
        {
            ...
            int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, 61);  //this is the dust that this projectile will spawn
