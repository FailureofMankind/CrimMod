...
namespace CrimsonsMod.Projectiles.scythe
{
    ...
    { 
        ...
        public override void AI()
        {
            ...
            int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, 33);  //this is the dust that this projectile will spawn
            Main.dust[dust].velocity /= 5f;
            Main.dust[dust].scale = 2.4f;
 
            if(Main.rand.Next(5)==0)
            {
            Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, Main.rand.Next(-7, 7), Main.rand.Next(-7, 7), 410, 50, 0, Main.myPlayer);
            }
