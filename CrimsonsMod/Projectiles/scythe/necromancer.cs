...
namespace CrimsonsMod.Projectiles.scythe
{
    ...
    { 
		...
		public override void OnHitNPC(NPC target, int damage, float knockBack, bool crit)
		{
            ...
            if(randomSpwan == 2)
                {
			        Main.PlaySound(SoundID.NPCDeath55, projectile.position);        
                    
                    int a = Projectile.NewProjectile(Main.MouseWorld.X, Main.MouseWorld.Y, 0, 0, 16, 7, 2, Main.myPlayer); //Spawning a projectile
        ...
        public override void AI()
        {
            ...
            int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, 56);  //this is the dust that this projectile will spawn
