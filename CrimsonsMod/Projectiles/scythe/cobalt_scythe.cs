...
{
    public class cobalt_scythe : ModProjectile  
    { 
        public override void SetStaticDefaults()
        {
        
		    DisplayName.SetDefault("cobalt_scythe");
        ...
        public override void AI()
        {
            ...
            int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, 41);  //this is the dust that this projectile will spawn
