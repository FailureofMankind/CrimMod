...
{
    public class temple_raid : ModProjectile  
    { 
		...
		{
            Projectile.NewProjectile(projectile.Center.X, (int)(projectile.Center.Y-1000), Main.rand.Next(-3, 3), 15, mod.ProjectileType("sols_wrath"), projectile.damage, projectile.knockBack, Main.myPlayer, 0f, 0f); //Spawning a projectile


		    target.AddBuff(24, 800); //inflicts "fire" debuff
			
            Main.PlaySound(SoundID.NPCHit44, projectile.position);        
	    }
