...
{
    public class the_hallow : ModProjectile  
    { 
        ...
        public override void AI()
        {
            ...
            int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, 57);  //this is the dust that this projectile will spawn
