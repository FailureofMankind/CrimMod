...
{
	public class tungsten_kunai_proj : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("tungsten_kunai_proj");
		}
			...
			ref int hitDirection)
		{
			...
			projectile.damage = 15; // Makes sure the sticking javelins do not deal damage anymore            
