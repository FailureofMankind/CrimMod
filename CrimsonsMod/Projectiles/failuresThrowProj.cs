...
{
    public class failuresThrowProj : ModProjectile  
    { 
        ...
        public override void AI()
        {
            ...
            {
                Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, saveShotX, saveShotY, mod.ProjectileType("failuresThrowProjProj"), projectile.damage, projectile.knockBack, Main.myPlayer, 0f, 0f); //Spawning a projectile
                isShooting = false;
