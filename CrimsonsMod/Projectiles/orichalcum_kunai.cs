...
using CrimsonsMod.Items.Weapons;
...
{
	public class orichalcum_kunai : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
            ...
            for(int i = 0; i < 5; i++)
            {
                Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, Main.rand.Next(-5, 5), Main.rand.Next(-5, 5), 221, 50, 0, Main.myPlayer); //Spawning a projectile
            }
			...
			ref int hitDirection)
		{
			...
			int maxStickingJavelins = 25; // This is the max. amount of javelins being able to attach
		...
		private const float maxTicks = 10f;
